...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (prevScreenRef.current === "login" && screen === "pre-ride") {
    ...
    <div className="min-h-dvh bg-[#F8FAFC] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {success && (
                <div className="flex items-start gap-2.5 p-3.5 rounded-xl bg-emerald-50 border border-emerald-100">
                  ...
                  <p className="text-sm text-emerald-700 leading-relaxed">Login successful! Redirecting...</p>
                </div>
              )}
        ...
        <div className="text-center mt-8 animate-fade-in">
          <p className="text-gray-300 text-[11px] tracking-widest uppercase font-medium">Secure Connection</p>
        </div>
      </div>
    </div>
  );
